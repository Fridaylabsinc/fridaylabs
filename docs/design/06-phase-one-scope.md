...
| **4 — Ecosystem Integration** | Year 2+ | Propose merge into Frappe core (or formal Frappe Apps integration) | Frappe community engagement |

This document focuses on **Phase 1**.

## Phase 1 Goal

A working Friday installation on a single Frappe site that demonstrates the core thesis:
...
### Friday App (custom Frappe app)
- App scaffold: `bench new-app friday`
- Modules created: `gateway`, `agents`, `skills`, `tasks`, `messaging`, `permissions`
- GPL v3 LICENSE, README, basic CONTRIBUTING.md
...
| 2 | Friday app scaffolded; DocTypes 1–4 created | DocTypes visible in Frappe Desk; can create rows manually |
